    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon">
          ...
          <Sun className="h-[1.2rem] w-[1.2rem] scale-100 transition-all duration-1000 dark:scale-0 ease-in-out"/>
          <Moon className="absolute h-[1.2rem] w-[1.2rem] scale-0 transition-all duration-1000 dark:scale-100 ease-in-out"/>
